...
| 直播 | Swift 已有 m3u/txt 分组播放、XMLTV EPG、catchup、headers/DRM 元数据、台标/频道号、收藏和隐藏分组解锁 | 需要新增 Bridge live API | DRM 播放支持、直播源历史和主页源管理 | P1/P2 |
...
- Swift 直播模型扩展：补 DRM/ClearKey 播放支持、直播源历史和主页直播源管理。
